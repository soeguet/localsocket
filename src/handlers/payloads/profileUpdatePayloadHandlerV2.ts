...
import { PayloadSubType, type ClientEntity, type ClientListPayload, type ClientUpdatePayload, type ProfilePictureObject } from "../../types/payloadTypes";
import { fetchProfilePicture, persistProfilePicture, retrieveAllRegisteredUsersFromDatabase, updateClientProfileInformation } from "../databaseHandler";
import { validateclientUpdatePayload } from "../typeHandler";
import { generateUnixTimestampFnv1aHash } from "../../helper/hashGenerator";


export async function profileUpdatePayloadHandlerV2(payloadFromClientAsObject: unknown, ws: ServerWebSocket<WebSocket>, server: Server) {
