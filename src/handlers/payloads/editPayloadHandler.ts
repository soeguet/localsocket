...
import { editMessageContent, retrieveUpdatedMessageFromDatabase } from "../databaseHandler";
import { validateEditPayload } from "../typeHandler";

export async function editPayloadHandler(payloadFromClientAsObject: unknown, ws: ServerWebSocket<WebSocket>, server: Server) {
