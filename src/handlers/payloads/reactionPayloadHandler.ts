...
import { persistReactionToDatabase, retrieveUpdatedMessageFromDatabase } from "../databaseHandler";
import { validateReactionPayload } from "../typeHandler";

export async function reactionPayloadHandler(payloadFromClientAsObject: unknown, ws: ServerWebSocket<WebSocket>, server: Server) {
