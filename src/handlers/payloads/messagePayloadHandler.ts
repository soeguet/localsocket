...
import { persistMessageInDatabase, retrieveLastMessageFromDatabase } from "../databaseHandler";
import { validateMessagePayload } from "../typeHandler";

export async function messagePayloadHandler(payloadFromClientAsObject: unknown, ws: ServerWebSocket<WebSocket>, server: Server) {
